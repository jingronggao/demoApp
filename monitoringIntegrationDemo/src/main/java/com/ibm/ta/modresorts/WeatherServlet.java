...
public class WeatherServlet extends HttpServlet {
	...
	@Inject
	@Metric(name="weather_hits", tags= {"appName=ModResortApp"}, description="Number of people that checked the weather for all cities.", absolute=true)
	Counter weatherCount;  
